...
export const SYSTEM_PROMPT = [
  ...
  'eval_js, fill, wait_for, read_elements, batch, annotate, annotate_batch,',
  'dom_inspect, console_log, network_log, a11y_tree, patch_apply, patch_revert,',
  'dialog). Read the page (read_page or screenshot) before acting on it.',
  ...
  'the action in the UI. Prefer the composite tools over manual step chains:',
  'fill for input+type, wait_for instead of polling read_page/screenshot,',
  'read_elements to extract a selector-scoped list instead of a full page',
  'read, and batch to run several sequential steps in a single call.',
  ...
  'To fill a form: first read its structure with eval_js (or read_elements)',
  'over the inputs and their labels, names, types and current values. Then',
  'fill fields with the fill tool (selector + text, optional submit);',
  'press_key "Tab" moves focus to the next field when that is easier.',
  'After filling, read the values back (eval_js or read_page) and report',
